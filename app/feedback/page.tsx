  ...
  const fetchUserQuestions = async () => {
    try {
      ...
      const transformedData: FeedbackQuestion[] = (result.data || []).map((item: any) => ({
        ...
        user: {
          displayName: user?.user_metadata?.display_name || user?.email?.split('@')[0] || 'Test User',
      ...
      <div className="p-6 w-full">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-1">Ask questions and get help from our team</p>
            </div>
          </div>
        </div>
        ...
        {authLoading ? (
          ...
          <div className="text-center py-12 bg-gray-900 rounded-xl border border-gray-800">
            ...
            <h3 className="text-xl font-medium text-gray-300 mb-2">Sign In Required</h3>
            <p className="text-gray-500 mb-6">Please sign in to submit feedback and view your questions</p>
          ...
          <div>
            ...
            {submitSuccess && (
              <div className="mb-6 p-4 bg-green-900/50 border border-green-500/50 rounded-lg flex items-center gap-3">
                ...
                <span className="text-green-400">Your question has been submitted successfully!</span>
              </div>
            )}
            ...
            {showForm ? (
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-gray-900 rounded-xl border border-gray-800 p-8">
                  <h2 className="text-2xl font-bold text-white mb-6">Submit Your Question</h2>
              ...
              <div>
                <div className="mb-6">
                  <h2 className="text-xl font-bold text-white mb-2">Your Questions</h2>
                  <p className="text-gray-400">Track the status of your submitted questions</p>
                </div>

                {loading ? (
                  <div className="text-center py-12">
                    <div className="animate-spin w-8 h-8 border-2 border-purple-500 border-t-transparent rounded-full mx-auto"></div>
                    <p className="text-gray-400 mt-4">Loading your questions...</p>
                  </div>
                        ...
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              <span className={`px-2 py-1 rounded-full border ${statusColors[question.status]}`}>
                                {statusIcons[question.status]}
                                <span className="ml-1 capitalize">{question.status.replace('_', ' ')}</span>
                              </span>
                          ...
                          <div className="mt-4 p-4 bg-gray-800 rounded-lg border-l-4 border-green-500">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="text-xs text-gray-500">
                                {question.respondedAt && formatDate(question.respondedAt)}
                              </span>
                            </div>
                            <p className="text-gray-300 mb-3">{question.adminResponse}</p>
                            <button
                              onClick={() => {
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-white">Reply to Admin</h3>
                <button
                  onClick={() => {
                    setShowReplyModal(false);
                    setSelectedQuestion(null);
              ...
              <div className="mb-4">
                <h4 className="text-white font-medium mb-2">{selectedQuestion.title}</h4>
                <p className="text-gray-400 text-sm">{selectedQuestion.content}</p>
              </div>
              ...
              {selectedQuestion.adminResponse && (
                <div className="mb-4 p-3 bg-gray-800 rounded-lg border-l-4 border-green-500">
                  ...
                  <p className="text-gray-300 text-sm">{selectedQuestion.adminResponse}</p>
                </div>
              )}
