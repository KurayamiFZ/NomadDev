          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 w-full focus:border-purple-500 focus:outline-none text-sm backdrop-blur-sm"
              />
            </div>
              ...
              <button
                ...
                className={`group relative p-6 rounded-2xl border-2 transition-all ${
                  selectedPath === path.id
                    ? "bg-linear-to-br from-purple-500/20 to-pink-500/20 border-purple-500"
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-left">
                    <div className="font-black text-lg">{path.name}</div>
                    <div className="text-xs text-gray-400">
