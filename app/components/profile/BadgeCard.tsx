    ...
    >
      ...
      <div className="transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-12 relative z-10">
        <IconWrapper 
          ...
          className={badge.earned ? "bg-yellow-500/20 group-hover:bg-yellow-500/30 transition-colors duration-300" : ""}
        />
      </div>

      {/* Badge Title */}
      <h3 className={`text-lg font-bold text-center transition-colors duration-300 relative z-10 ${
        badge.earned 
      ...
      <p className="text-sm font-light text-center transition-colors duration-300 relative z-10">
        <span className={badge.earned ? "text-gray-400 group-hover:text-gray-300" : "text-gray-500"}>
          {badge.description}
        </span>
      </p>
