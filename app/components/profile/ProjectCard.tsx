...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    ...
    >
      ...
      <div
        className={`flex justify-end items-start w-full h-48 bg-linear-to-br ${project.color} relative overflow-hidden group`}
      >
      ...
      <div className="px-6 pb-6 w-full space-y-3 relative">
        ...
        {/* Project Title */}
        <h3 className="font-bold text-xl text-white group-hover:text-purple-400 transition-colors duration-300 relative z-10 transform group-hover:scale-105">
          {project.name}
        </h3>
        ...
        <div className="flex gap-4 text-sm text-gray-500 relative z-10">
          <span className="flex items-center gap-1.5 transform transition-transform duration-300 hover:scale-110">
            <Heart className="w-4 h-4 text-red-400 group-hover:text-red-300 transition-colors duration-300" />{" "}
            {project.likes}
          </span>
          <span className="flex items-center gap-1.5 transform transition-transform duration-300 hover:scale-110">
            <Eye className="w-4 h-4 text-blue-400 group-hover:text-blue-300 transition-colors duration-300" />{" "}
            {project.views}
          </span>
        </div>
      </div>
