    ...
    return (
      <div className="flex min-h-screen w-full bg-black items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-lg">Профайлыг уншиж байна...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-screen w-full bg-black items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-4">Профайлын алдаа</h1>
          <p className="text-gray-400 mb-8">
            {error || "Таны профайлын мэдээллийг уншиж чадсангүй."}
          </p>
