...
export default function Curriculum() {
  ...
  return (
    <div
      className="flex flex-col justify-center min-h-screen w-screen 
                bg-neutral-950 
    ...
    >
      <div className="flex justify-between w-full h-1/12">
        ...
        <span className="self-center bg-[linear-gradient(to_right,#A95BF0,#E94D9B)] bg-clip-text text-transparent font-extrabold font-[Inter] text-6xl mb-8 p-4">
          Plans
        </span>
      ...
      <div className="flex w-3/4 h-[800px] rounded-4xl bg-black/50 border-2 border-white ">
        ...
        <div className="flex flex-col justify-center space-y-2 w-1/3 h-full rounded-l-4xl border border-white">
          ...
          <span className="font-extrabold font-[Inter] m-4 text-white">
            ✔ Benefits
          </span>
          <span className="font-extrabold font-[Inter] m-4 text-white">
            ✔ Benefits
          ...
          <span className="font-[Inter] m-4 text-gray-400">✖ Benefit</span>
          <button
            className="self-center text-white m-4 w-4/6 h-1/10 font-bold bg-black/50 hover:bg-stone-300 rounded-full border-2 border-white"
        ...
        <div className="flex flex-col justify-center space-y-2 w-1/3 h-full border border-white">
          <span className="flex text-white self-center text-3xl mt-4 font-bold font-[Inter]">
            Basic
          </span>
          <span className="font-extrabold font-[Inter] m-4 text-white">
            ✔ Benefits
        ...
        <div className="flex flex-col justify-center space-y-2 w-1/3 h-full rounded-r-4xl border border-white">
          <span className="flex text-white self-center text-3xl mt-4 font-extrabold font-[Inter]">
            Premium
          </span>
          <span className="font-extrabold font-[Inter] m-4 text-white">
            ✔ Benefits
